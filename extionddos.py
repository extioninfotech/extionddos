...
# Clear the terminal
os.system("clear")
os.system("figlet ExtionDdos")
# Print the banner

print(colored("Extion Infotech DDoS Tool", 'red'))
print(colored("Author   : Extion Infotech", 'green'))
print(colored("Website : https://www.extioninfotech.com", 'magenta'))
print(colored("Github   : https://github.com/extioninfotech", 'red'))
print(colored("Linkedin : https://www.linkedin.com/company/extion-infotech/posts/?feedView=all", 'magenta'))
...
print(colored("Extion Infotech is not responsible for misusing it and must have an NDA signed to perform such attacks", 'red'))
print(colored("You are using ExtionDdos Version: 2.0", 'yellow'))
print()
